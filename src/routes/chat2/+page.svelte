		...
		<div class="flex flex-col px-8">
			...
			<div class="flex flex-col pt-4 pb-4 px-4 rounded-md bg-white gap-4 justify-center">
				...
				<div class={prompt_menu_active ? 'hidden' : ''}>
					<div class="flex items-end flex-row mt-4">
						<a class="text-xl font-bold" href="/">Prompt 1</a>
					</div>
					<div class="flex items-end flex-row mt-4">
						<a class="text-xl font-bold" href="/chat2">Prompt 2</a>
						<p class="text-green-500 pl-4">Selected</p>
					</div>
				</div>
			</div>
		</div>
